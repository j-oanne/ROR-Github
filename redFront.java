...
public class redFront extends LinearOpMode {
    ...
    private static final String[] LABELS = {"redProp"};     // Define the labels recognized in the model for TFOD (must be in training order!)
    ...
    public void runOpMode() throws InterruptedException {
        ...
        start = new Pose2d(convertLocToVec("F4").plus(new Vector2d(x_offset,y_offset)), Math.toRadians(90));
    ...
    private void middle() {
        ...
        Vector2d spike = convertLocToVec("E4").plus(new Vector2d(x_offset,6));
        Vector2d board = convertLocToVec("E6").plus(new Vector2d(-9,-2));
        ...
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)
                ...
                .lineToSplineHeading(new Pose2d(convertLocToVec("F4").plus(new Vector2d(x_offset, 0)), Math.toRadians(90)))
                .waitSeconds(DELAY)
        ...
        t = drive.trajectorySequenceBuilder(t.end())
                ...
                .lineToLinearHeading(new Pose2d(convertLocToVec("F5"), Math.toRadians(180)))
                .waitSeconds(DELAY)

                // Park on the edge
                .lineTo(convertLocToVec("F6").plus(new Vector2d(3,-1)))
                .waitSeconds(DELAY)
                .build();
        drive.followTrajectorySequence(t);
    }
    ...
    private void right() {
        ...
        Vector2d spike = convertLocToVec("B4").plus(new Vector2d(13,3));
    ...
    private void left() {
        ...
        Vector2d spike = convertLocToVec("F4").plus(new Vector2d(-5,-2));
        Vector2d board = convertLocToVec("F6").plus(new Vector2d(-9,4));

        // Trajectory from start to backdrop
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)

                .lineTo(convertLocToVec("F4").plus(new Vector2d(x_offset,-2)))
                .waitSeconds(DELAY)
