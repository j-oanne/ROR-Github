...
public class blueBack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        start = new Pose2d(convertLocToVec("A2").plus(new Vector2d(x_offset,y_offset)), Math.toRadians(270));
    ...
    private void middle() {
        ...
        Vector2d spike = convertLocToVec("B2").plus(new Vector2d(x_offset,-6));
        Vector2d board = convertLocToVec("B6").plus(new Vector2d(-9,-4));
        ...
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)
                ...
                .lineToSplineHeading(new Pose2d(convertLocToVec("A2").plus(new Vector2d(x_offset, 0)), Math.toRadians(270)))
                .waitSeconds(DELAY)
        ...
        t = drive.trajectorySequenceBuilder(t.end())
                ...
                // Park on the edge
                .lineTo(convertLocToVec("A6").plus(new Vector2d(3,1)))
                .waitSeconds(DELAY)
                .build();
        drive.followTrajectorySequence(t);
    }
    ...
    private void left() {
        ...
        Vector2d spike = convertLocToVec("B2").plus(new Vector2d(6,0));
        Vector2d board = convertLocToVec("B6").plus(new Vector2d(-9,4));

        // Trajectory from start to backdrop
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)

                // Move forward just like in middle
                .lineToSplineHeading(new Pose2d(convertLocToVec("B2").plus(new Vector2d(x_offset)), Math.toRadians(270)))
                .waitSeconds(DELAY)
    ...
    private void right() {
        ...
        Vector2d spike = convertLocToVec("B2").plus(new Vector2d(-13,-3));
        Vector2d board = convertLocToVec("B6").plus(new Vector2d(-10,-8));
        ...
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)
                ...
                // Back to starting coordinate
                .back(15)
                .lineToSplineHeading(new Pose2d(convertLocToVec("A2").plus(new Vector2d(x_offset, 3)), Math.toRadians(270)))
                .waitSeconds(DELAY)

                // Turn and move backwards underneath rigging
                .turn(Math.toRadians(-100))
                .waitSeconds(DELAY)
                .lineToLinearHeading(new Pose2d(convertLocToVec("A5").plus(new Vector2d(0,0)), Math.toRadians(180)))
                .waitSeconds(DELAY)
