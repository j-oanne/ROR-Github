...
public class redBack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        start = new Pose2d(convertLocToVec("F2").plus(new Vector2d(x_offset,y_offset)), Math.toRadians(90));
    ...
    private void middle() {
        ...
        Vector2d spike = convertLocToVec("E2").plus(new Vector2d(x_offset,6));
        Vector2d board = convertLocToVec("E6").plus(new Vector2d(-9,-1));
        ...
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)
                ...
                .lineToSplineHeading(new Pose2d(convertLocToVec("F2").plus(new Vector2d(x_offset,0)), Math.toRadians(90)))
                .waitSeconds(DELAY)

                // Turn and move backwards underneath rigging
                .turn(Math.toRadians(102))
                .waitSeconds(DELAY)

                .lineToLinearHeading(new Pose2d(convertLocToVec("F5").plus(new Vector2d(0,1)), Math.toRadians(180)))
                .waitSeconds(DELAY)
        ...
        t = drive.trajectorySequenceBuilder(t.end())
                .lineToLinearHeading(new Pose2d(board.plus(new Vector2d(3,0)), Math.toRadians(180)))
                .waitSeconds(DELAY)
                .build();
        drive.followTrajectorySequence(t);
        ...
        t = drive.trajectorySequenceBuilder(t.end())
                ...
                .lineToLinearHeading(new Pose2d(convertLocToVec("F5").plus(new Vector2d(0,-3)), Math.toRadians(180)))
                .waitSeconds(DELAY)

                // Park on the edge
                .lineTo(convertLocToVec("F6").plus(new Vector2d(3,-4)))
                .waitSeconds(DELAY)
                .build();
        drive.followTrajectorySequence(t);
    }
    ...
    private void left() {
        ...
        Vector2d spike = convertLocToVec("E2").plus(new Vector2d(-13,3));
        Vector2d board = convertLocToVec("E6").plus(new Vector2d(-9,4));
    ...
    private void right() {
        ...
        Vector2d spike = convertLocToVec("E2").plus(new Vector2d(6,0));
        Vector2d board = convertLocToVec("E6").plus(new Vector2d(-10,-8));

        // Trajectory from start to backdrop
        TrajectorySequence t = drive.trajectorySequenceBuilder(start)

                .lineToSplineHeading(new Pose2d(convertLocToVec("F2").plus(new Vector2d(x_offset)), Math.toRadians(90)))
                .waitSeconds(DELAY)

                .turn(Math.toRadians(-100))
                .lineToSplineHeading(new Pose2d(spike, Math.toRadians(0)))
